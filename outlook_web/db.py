    ...
    try:
        with create_sqlite_connection() as db:
            ...
            if not row:
                ...
                db.execute("CREATE TABLE IF NOT EXISTS groups (id INTEGER PRIMARY KEY AUTOINCREMENT, name UNIQUE, description, color DEFAULT '#1a1a1a')")
